...
export class AppComponent implements AfterViewInit {
  ...
  public certificates: {image: any, document: any}[] = [];
  public skills: any[];
  ...
  constructor(
    ...
    httpClient.get('assets/data/info.json').subscribe(
      (data: any) => {
        this.experiences = data.experiences;
        this.skills = data.skills;

        data.certificates.forEach(
          certificate => this.certificates.push({
            "image": certificate + ".jpg",
            "document": sanitizer.bypassSecurityTrustResourceUrl(certificate + ".pdf")
          })
        );

        this.skills.sort((a,b) => parseInt(b.percent) - parseInt(a.percent));

        setTimeout(this.initCertificateLightbox.bind(this), 1000);
  ...
  ngAfterViewInit(): void {
    this.processJavascriptFunctions();
  }

  processJavascriptFunctions() {
    /**
